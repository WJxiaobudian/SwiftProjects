...
extension Calculatable {
    ...
    static func detailCollectionViewHieght(_ thumbImages: [ThumbImage]) -> CGFloat {
        ...
        case 3: return imageThreeWidth + 5
        case 4: return (KscreenWidth - 3)
        case 5, 6: return (imageThreeWidth + 5) * 2
        case 7...9: return (imageThreeWidth + 5) * 3
        default: return 0
        }
    }
    ...
    static func detailCollectionViewCellSize(_ thumbImages: [ThumbImage]) -> CGSize {
        ...
        case 3, 5...9: return CGSize(width: imageThreeWidth, height: imageThreeWidth)
        default: return .zero
        }
    }
    ...
    static func collectionViewWidth(_ count: Int) -> CGFloat {
        switch count {
        case 1, 2: return (imageTwoWidth + 5) * 2
        case 3, 5...9: return KscreenWidth - 30
        case 4: return (imageThreeWidth + 5) * 2
        default: return 0
        }
    }
    ...
    static func collectionViewHeight(_ count: Int) -> CGFloat {
        switch count {
        case 1, 2: return imageTwoWidth
        case 3: return imageThreeWidth + 5
        case 4...6: return (imageThreeWidth + 5) * 2
        case 7...9: return (imageThreeWidth + 5) * 3
        default: return 0
        }
    }
    ...
    static func collectionViewCellSize(_ count: Int) -> CGSize {
        switch count {
        case 1, 2: return CGSize(width: imageTwoWidth, height: imageTwoWidth)
        case 3...9: return CGSize(width: imageTwoWidth, height: imageThreeWidth)
        default: return .zero
        }
    }
